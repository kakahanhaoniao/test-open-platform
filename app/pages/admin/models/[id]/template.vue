...
import { models, getDefaultTemplate } from '~/data/mock'
...
const storageKey = `admin-template-${modelId}`
...
const template = reactive<PageTemplate>(
  savedTemplate
    ...
    : getDefaultTemplate('model', modelId)
)
...
// Drag state for CSS-only drag-sort
