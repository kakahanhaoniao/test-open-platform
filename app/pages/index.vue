    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-white via-primary-50/30 to-accent-50/20">
      ...
      <div class="relative max-w-7xl mx-auto px-6 pt-24 pb-20">
        <div class="max-w-3xl mx-auto text-center">
          <!-- Badge -->
          <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-50 border border-primary-100 mb-8">
          ...
          <!-- Subtitle -->
          <p class="text-lg md:text-xl text-gray-500 leading-relaxed max-w-2xl mx-auto mb-10">
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <ul class="space-y-2.5">
              <li><NuxtLink to="/marketplace" class="text-sm text-gray-500 hover:text-primary-600 transition-colors">API文档</NuxtLink></li>
              <li><NuxtLink to="/marketplace" class="text-sm text-gray-500 hover:text-primary-600 transition-colors">SDK下载</NuxtLink></li>
              <li><NuxtLink to="/marketplace" class="text-sm text-gray-500 hover:text-primary-600 transition-colors">开发者指南</NuxtLink></li>
              <li><NuxtLink to="/marketplace" class="text-sm text-gray-500 hover:text-primary-600 transition-colors">帮助中心</NuxtLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2.5">
              ...
              <li><span class="text-sm text-gray-500">联系销售</span></li>
            </ul>
          </div>
        </div>
